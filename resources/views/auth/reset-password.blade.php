        ...
        <div class="w-full md:w-7/12 p-10 lg:p-14 sm:pl-16 flex flex-col justify-center bg-white">
            <div class="max-w-md w-full mx-auto md:mx-0">
                ...
                <form method="POST" action="{{ route('password.update') }}" class="space-y-6">
                    ...
                    <div class="pt-4">
                        <button type="submit" class="w-full flex justify-center items-center py-4 px-4 rounded-xl text-sm font-bold text-white bg-[#345344] hover:bg-gray-800 focus:outline-none focus:ring-4 focus:ring-white/10 transition-all duration-300 shadow-md">
                            SIMPAN SANDI BARU
                        </button>
                    </div>
                </form>
