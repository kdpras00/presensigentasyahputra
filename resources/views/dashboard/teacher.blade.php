...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <div class="bg-white rounded-xl border border-gray-100 p-5">
            <p class="text-xs font-semibold text-gray-600 uppercase tracking-wider mb-3">Hadir</p>
            <p class="text-3xl font-bold text-gray-900 tracking-tight">{{ $presentToday }}</p>
            <p class="text-xs text-gray-600 mt-1">Tepat waktu</p>
        </div>
        ...
        <div class="bg-white rounded-xl border border-gray-100 p-5">
            ...
            <p class="text-xs text-gray-600 mt-1">Lewat batas</p>
        </div>

        <div class="bg-white rounded-xl border border-gray-100 p-5">
            <p class="text-xs font-semibold text-gray-600 uppercase tracking-wider mb-3">Absen</p>
            <p class="text-3xl font-bold text-gray-900 tracking-tight">{{ $absentToday }}</p>
            <p class="text-xs text-gray-600 mt-1">Belum hadir</p>
        </div>

        <div class="bg-white rounded-xl border border-gray-100 p-5">
            <p class="text-xs font-semibold text-gray-600 uppercase tracking-wider mb-3">Pulang</p>
            <p class="text-3xl font-bold text-gray-900 tracking-tight">{{ $checkedOutToday }}</p>
            <p class="text-xs text-gray-600 mt-1">Sudah checkout</p>
        </div>
    </div>
            ...
            <table class="w-full text-left">
                <thead>
                    <tr class="bg-gray-50/50">
                        <th class="px-6 py-3 text-xs font-semibold text-gray-600 uppercase tracking-wider">Nama Siswa</th>
                        <th class="px-6 py-3 text-xs font-semibold text-gray-600 uppercase tracking-wider text-center">Kelas</th>
                        <th class="px-6 py-3 text-xs font-semibold text-gray-600 uppercase tracking-wider text-center">Jam Masuk</th>
                        <th class="px-6 py-3 text-xs font-semibold text-gray-600 uppercase tracking-wider text-center">Ket. Masuk</th>
                        <th class="px-6 py-3 text-xs font-semibold text-gray-600 uppercase tracking-wider text-center">Jam Keluar</th>
                        <th class="px-6 py-3 text-xs font-semibold text-gray-600 uppercase tracking-wider text-center">Ket. Keluar</th>
                        ...
                        <tr class="hover:bg-gray-50/50 transition-colors">
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    <div class="w-9 h-9 rounded-lg bg-gray-100 flex items-center justify-center text-gray-600 text-sm font-semibold shrink-0">
                            ...
                            <td class="px-6 py-4 text-center">
                                <span class="text-sm text-gray-600">{{ $activity->student->class ?? '-' }}</span>
                            </td>
                            <td class="px-6 py-4 text-center">
                            ...
                            <td class="px-6 py-4 text-center">
                                @if($activity->check_in_at)
                                    @if($activity->check_in_status == 'present')
                                        <span class="text-sm font-semibold text-green-700">Tepat Waktu</span>
                                    @else
                            ...
                            <td class="px-6 py-4 text-center">
                                @if($activity->check_out_at)
                                    ...
                                    @else
                                        <span class="text-sm font-semibold text-orange-700">Pulang Awal</span>
                                    @endif
                                @else
                                    <span class="text-gray-600">—</span>
                                @endif
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="px-6 py-16 text-center">
                                <p class="text-sm text-gray-600 font-medium">Belum ada aktivitas absensi hari ini</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
