    ...
    <div class="bg-white rounded-3xl shadow-lg border-transparent p-10">
        ...
        <div class="grid gap-6 md:grid-cols-2">
            ...
            <div>
                ...
                <input type="text" id="username" name="username" class="bg-[#F3F4F6] border-transparent text-gray-900 text-sm rounded-xl focus:ring-4 focus:ring-[#345344]/20 focus:border-[#345344] block w-full p-4 transition-all placeholder-gray-400" placeholder="johndoe" required value="{{ old('username', $student->user->username) }}">
