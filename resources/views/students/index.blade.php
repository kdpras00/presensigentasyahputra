...
<div class="space-y-8">
    ...
    <div class="bg-[#345344] rounded-[2.5rem] p-10 relative overflow-hidden shadow-2xl shadow-[#345344]/20">
        <div class="relative z-10">
            <h2 class="text-4xl font-black text-white leading-tight tracking-tighter mb-2">Manajemen Siswa</h2>
            <p class="text-white/60 text-sm font-medium">Kelola data siswa, kelas, dan akun sistem secara terpusat.</p>
        </div>
    ...
    <div class="bg-white rounded-[2.5rem] shadow-[0_10px_40px_rgba(0,0,0,0.03)] border border-gray-50 overflow-hidden">
        <div class="px-10 py-4 border-b border-gray-200 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div class="flex items-center gap-3 w-full md:w-auto">
                ...
                <a href="{{ route('students.create') }}" class="bg-white text-[#345344] text-sm font-bold px-6 py-3 rounded-2xl transition-all shadow-lg shadow-black/5 border border-gray-100 flex items-center gap-2 whitespace-nowrap">
